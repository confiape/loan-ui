...
(function (_) {
  ...
  try {
    ...
    (0, _._F_toggles_initialize)([0x2e244000, 0xe60]);
      ...
      e.all = function (g) {
        ...
        return k.done
          ...
          : new e(function (m, n) {
              ...
              var r = [],
                p = 0;
              do (r.push(void 0), p++, c(k.value).lb(q(r.length - 1), n), (k = h.next()));
              while (!k.done);
            });
      };
      return e;
          ...
          if (n && na(h[0], m))
            for (h = 0; h < n.length; h++) {
              ...
              if ((k !== k && q.key !== q.key) || k === q.key)
                return { id: m, list: n, index: h, V: q };
            }
  ...
  try {
    ...
    */
    ...
    _.Ga = function () {
      return _.za()
        ? _.xa('Chromium')
        : ((_.w('Chrome') || _.w('CriOS')) && !_.Da()) || _.w('Silk');
    };
    _.Ia = function (a) {
      var b = {};
    ...
    eb = function (a) {
      return !Array.isArray(a) || a.length ? !1 : (0, _.db)(a) & 1 ? !0 : !1;
    };
    _.fb = function (a) {
      if (a & 2) throw Error();
    };
    ...
    _.nb = function (a, b, c) {
      if (a != null && typeof a === 'object' && a.pb === mb) return a;
      if (Array.isArray(a)) {
        var d = (0, _.db)(a),
          e = d;
        e === 0 && (e |= c & 32);
    ...
    _.zb = function (a) {
      switch (typeof a) {
        ...
        case 'bigint':
          return (0, _.wb)(a) ? Number(a) : String(a);
        case 'boolean':
          return a ? 1 : 0;
        case 'object':
          if (a)
            if (Array.isArray(a)) {
              ...
              if (_.xb && a != null && a instanceof Uint8Array) return _.Sa(a);
              if ('function' == typeof _.yb && a instanceof _.yb) return a.i();
            }
      }
      return a;
    };
    ...
    Cb = function (a, b, c, d, e) {
      if (a != null) {
        if (Array.isArray(a))
          a = eb(a) ? void 0 : e && (0, _.db)(a) & 2 ? a : Bb(a, b, c, d !== void 0, e);
        else if (cb(a)) {
          var f = {},
            g;
          for (g in a) f[g] = Cb(a[g], b, c, d, e);
          a = f;
        } else a = b(a, d);
        return a;
      }
    ...
    Bb = function (a, b, c, d, e) {
      var f = d || c ? (0, _.db)(a) : 0;
      d = d ? !!(f & 32) : void 0;
      for (var g = _.Wa(a), h = 0; h < g.length; h++) g[h] = Cb(g[h], b, c, d, e);
      c && (hb(g, a), c(f, g));
      return g;
    };
    Db = function (a) {
    ...
    Eb = function (a, b, c) {
      c = c === void 0 ? $a : c;
      if (a != null) {
        if (_.xb && a instanceof Uint8Array) return b ? a : new Uint8Array(a);
        if (Array.isArray(a)) {
          var d = (0, _.db)(a);
          if (d & 2) return a;
          b && (b = d === 0 || (!!(d & 32) && !(d & 64 || !(d & 16))));
          return b ? ((0, _.Ya)(a, (d | 34) & -12293), a) : Bb(a, Eb, d & 4 ? $a : c, !0, !0);
        }
        a.pb === mb &&
          ((c = a.A), (d = (0, _.Fb)(c)), (a = d & 2 ? a : _.qb(a.constructor, _.Gb(c, d, !0))));
        return a;
      }
    };
    _.Gb = function (a, b, c) {
    ...
    _.Ob = function (a) {
      ...
      if (c) {
        ...
        for (; c > 0; c--) {
          h = f[c - 1];
          if (!(h == null || eb(h) || (bb(h) && h.size === 0))) break;
          var r = !0;
        }
        if (f !== a || g || r) {
    ...
    _.Ub = function (a, b) {
      if (a instanceof _.z) return a.A;
      if (Array.isArray(a)) return _.vb(a, b, !1);
    };
    _.ac = function (a, b, c) {
      return new _.Sb(a, b, c);
    };
    ...
    _.C = function (a, b) {
      try {
        _.dc('error') &&
          ...
          window.console.error(_.ec(b) + a);
      } catch (c) {}
    };
    _.gc = function (a) {
      if (a instanceof _.fc) return a.g;
      throw Error('O');
    };
    ic = function (a) {
    ...
    _.lc = function (a) {
      var b = b === void 0 ? jc : b;
      a: if (((b = b === void 0 ? jc : b), !(a instanceof _.fc))) {
    ...
    _.Jc =
      _.w('Gecko') &&
      !(_.ua().toLowerCase().indexOf('webkit') != -1 && !_.w('Edge')) &&
    ...
    sd = function (a, b, c, d) {
      ...
      d = _.Kb(a, e, c, d);
      var f;
      if (d != null && d.pb === mb) return ((b = _.Hb(d)), b !== d && _.Jb(a, e, c, b), b.A);
      if (Array.isArray(d)) {
        var g = (0, _.db)(d);
        g & 2 ? (f = _.vb(_.Gb(d, g, !1), b, !0)) : g & 64 ? (f = d) : (f = _.vb(f, b, !0));
      } else f = _.vb(void 0, b, !0);
      f !== d && _.Jb(a, e, c, f);
      return f;
    };
    ...
    _.z.prototype.za = function () {
      return !!((0, _.db)(this.A) & 2);
    };
    _.z.prototype.pb = mb;
    _.z.prototype.toString = function () {
      try {
        return ((_.Nb = !0), _.Ob(this).toString());
      } finally {
        _.Nb = !1;
      }
    };
      ...
      a instanceof _.Ad
        ...
        : a && (b = String(a).match(_.yd))
          ? ((this.l = !1),
            ...
            _.Dd(this, b[6] || '', !0),
            (this.m = Fd(b[7] || '')))
          : ((this.l = !1), (this.j = new _.Gd(null, this.l)));
    };
    ...
    _.Cd = function (a, b) {
      if (b) {
        b = Number(b);
        if (isNaN(b) || b < 0) throw Error('R`' + b);
        a.s = b;
      } else a.s = null;
    };
    _.Dd = function (a, b, c) {
      b instanceof _.Gd
        ? ((a.j = b), Md(a.j, a.l))
        : (c || (b = Hd(b, Nd)), (a.j = new _.Gd(b, a.l)));
    };
    _.Od = function (a) {
    ...
    _.l.ka = function (a) {
      Qd(this);
      var b = [];
      if (typeof a === 'string') Sd(this, a) && (b = b.concat(this.g.get(Rd(this, a))));
      else {
    ...
    _.Td = function (a, b, c) {
      a.remove(b);
      c.length > 0 && ((a.i = null), a.g.set(Rd(a, b), _.Pa(c)), (a.h += c.length));
    };
      ...
      Md = function (a, b) {
        b &&
          ...
          a.g.forEach(function (c, d) {
            var e = d.toLowerCase();
            d != e && (this.remove(d), _.Td(this, e, c));
          }, a));
        a.j = b;
      };
    _.Ud = function () {
    ...
    var Xd = function (a, b) {
      ...
      if (a) {
        ...
        d
          ...
          : ((this.j = _.Kc || a.offsetX !== void 0 ? a.offsetX : a.layerX),
    ...
    _.ce.prototype.add = function (a, b, c, d, e) {
      ...
      g > -1
        ? ((b = a[g]), c || (b.kb = !1))
        : ((b = new ae(b, this.src, f, !!d, e)), (b.kb = c), a.push(b));
      return b;
    };
    ...
    _.ee = function (a, b) {
      ...
      var d = _.Oa(a.g[c], b);
      d && (_.be(b), a.g[c].length == 0 && (delete a.g[c], a.h--));
      return d;
    };
    ...
    _.L = function (a, b, c, d, e) {
      if (d && d.once) return _.ie(a, b, c, d, e);
      if (Array.isArray(b)) {
        for (var f = 0; f < b.length; f++) _.L(a, b[f], c, d, e);
        return null;
      }
      c = _.je(c);
    ...
    ke = function (a, b, c, d, e, f) {
      ...
      if (a.addEventListener)
        (Wd || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(), d, e));
    ...
    _.pe = function (a) {
      ...
      var b = a.src;
      if (_.Zd(b)) return b.Pc(a);
      var c = a.type,
        d = a.proxy;
      b.removeEventListener
        ? b.removeEventListener(c, d, a.capture)
        : b.detachEvent
          ? b.detachEvent(ne(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
      he--;
      (c = _.le(b)) ? (_.ee(c, a), c.h == 0 && ((c.src = null), (b[fe] = null))) : _.be(a);
      return !0;
    };
    ne = function (a) {
  ...
  try {
    ...
    _.mf = function (a, b, c) {
      if (c != null) {
        if (typeof c !== 'number') throw _.Va('int32');
        if (!Number.isFinite(c)) throw _.Va('int32');
        c |= 0;
      }
      return _.qd(a, b, c);
    };
    ...
    _.pf = function (a, b) {
      if (a)
        if (_.Zd(a)) a.Lc(b);
          ...
          for (var d in a.g)
            if (!b || d == b)
              for (var e = a.g[d].concat(), f = 0; f < e.length; ++f) _.pe(e[f]) && ++c;
        }
    };
    _.qf = function () {
      var a = this;
  ...
  try {
    ...
    _.$i = function (a, b, c, d) {
      ...
      var e = !!(64 & b) || !(16384 & b),
        ...
        g = f !== _.ed;
      if (e || !g) {
        var h = (e = g ? (0, _.db)(f) : 0);
        if (!g || 2 & h || _.gf(h) || (4 & h && !(32 & h)))
          ((f = _.Wa(f)), (h = _.ef(h, b)), (b = _.Jb(a, b, c, f)));
        h = _.ff(h, b) & -13;
  ...
  try {
    ...
    */
          ...
          case 0:
            ...
            if (m < 0) {
              ...
              (c.push(a.substring(k, m)),
                ...
                (k = m + 1),
                Nj
                  ? ((Oj.lastIndex = k), (m = Oj.exec(a)))
                  : ((Oj.lastIndex = 0), (m = Oj.exec(a.substring(k)))),
                m ? ((f = ['<', m[0]]), (g = m[1]), (e = 1), (k += m[0].length)) : c.push('<'));
            break;
          case 1:
            m = a.charAt(k++);
            switch (m) {
    ...
    _.Rj = function (a, b, c, d) {
      if ((b = b(c || Qj, d)) && b.h && a) b.h(a);
      else {
        a: if (_.oc(b)) {
          if (b.g && ((b = b.g()), b instanceof Hj)) break a;
          b = Kj('zSoyz');
        } else b = Kj(String(b));
        a.innerHTML = Jj(b);
      }
      ...
      c.getElementsByClassName
        ...
        : ((c = document),
          a
            ...
            : ((b = b || c),
              (a =
                (a ? b.querySelectorAll(a ? '.' + a : '') : b.getElementsByTagName('*'))[0] ||
                null)));
      return a || null;
    };
    _.Uj = function (a) {
    ...
    Yj.prototype.g = function () {
      if (this.jc !== _.Vj) throw Error('ja');
    ...
    _.W = function (a) {
      return _.bk(a, _.Vj)
        ...
        : a instanceof Hj
          ? (0, _.V)(Jj(a).toString())
          : (0, _.V)(String(String(a)).replace(ck, dk), _.ak(a));
    };
    _.V = (function (a) {
      function b(c) {
        this.sb = c;
    ...
    _.lk = function (a) {
      _.bk(a, _.Wj) || _.bk(a, _.Xj)
        ? (a = _.hk(a))
        : a instanceof _.fc
          ? (a = _.hk(_.gc(a)))
          : 'function' == typeof _.Ej && a instanceof _.Ej
            ? (a = _.hk(_.Gj(a).toString()))
            : ((a = String(a)), (a = ik.test(a) ? a.replace(_.jk, _.kk) : 'about:invalid#zSoyz'));
      return a;
    };
    _.bk = function (a, b) {
  ...
  try {
    ...
    _.Bk = function (a, b, c) {
      ...
      if (b && _.I(b, 7) === 2) {
        ...
        b && _.I(b, 10) === 2 && !_.U('disable_personalized_button')
          ? ((c = c === void 0 ? !0 : c),
            b && _.rd(b, _.gj, 8)
              ? ((d = {}),
                b &&
    ...
    var Nk = function (a, b, c, d, e, f, g, h) {
        ...
        return m(
          k +
            ...
            '"' +
            (f && !h
              ? ' style="width:' + _.X(Gk(f)) + 'px; max-width:400px; min-width:min-content;"'
              : '') +
            '><div class="' +
        ...
        return (0, _.V)(
          (a === void 0 ? 0 : a)
            ? '<div class="' +
                ...
                Hk() +
                '</div></div>'
            : '<div class="' + _.X('nsm7Bb-HzV7m-LgbsSe-Bz112c') + '">' + Hk() + '</div>',
        );
      };
    var Ck = function (a) {
        a = a || {};
        var b = a.Ra;
        return (0, _.V)(Nk(a.Ec, a.size, a.theme, a.shape, a.text, a.width, b === void 0 ? !0 : b));
      },
      yk = function (a) {
        a = a || {};
        var b = a.Ra;
        return (0, _.V)(
          Nk(void 0, a.size, a.theme, a.shape, a.text, void 0, b === void 0 ? !0 : b, !0),
        );
      },
      zk = function (a) {
        var b = a.Ra,
  ...
  try {
    ...
    ye = function (a) {
      if (typeof a === 'string') return { buffer: xe(a), za: !1 };
      ...
      if (a.constructor === _.yb) return { buffer: a.h() || new Uint8Array(0), za: !0 };
    ...
    Ce = function (a) {
      ...
      b = c.Dc
        ...
        : function (d, e) {
            for (var f = (0, _.Fb)(d); Ee(e) && e.h != 4; ) {
              var g = e.j,
                h = c[g];
              if (h == null) {
                var k = c.oc;
                k && (k = k[g]) && ((k = Fe(k)), k != null && (h = c[g] = k));
              }
              (h != null && h(e, d, g)) ||
                ((g = e),
                (h = g.i),
                ...
                k.zb
                  ...
                  : ((g = k.g.g - h),
                    ...
                    (k = k.g),
                    g == 0
                      ? (g = He || (He = new _.yb(null, Ie)))
                      : ((h = Je(k, g)),
                        k.hb && k.l
                          ? (g = k.i.subarray(h, h + g))
                          : ((k = k.i),
                            (g = h + g),
                            (g =
                              h === g
                                ...
                                : _.pd
                                  ? k.slice(h, g)
                                  : new Uint8Array(k.subarray(h, g)))),
                        (g = g.length == 0 ? He || (He = new _.yb(null, Ie)) : new _.yb(g, Ie))),
                    (h = g)),
                (g = d),
                h && (_.gb || (_.gb = Symbol()), (k = g[_.gb]) ? k.push(h) : (g[_.gb] = [h])));
            }
            f & 16384 && (0, _.ub)(d, 34);
            return !0;
          };
    ...
    _.Oe = function (a, b) {
      return function (c, d) {
        ...
        try {
          ...
          (c.g.clear(), (c.j = -1), (c.h = -1), Ke.length < 100 && Ke.push(c));
        }
        return h;
      };
    };
    ...
    _.yb.prototype.h = function () {
      if (Ie !== Ie) throw Error('v');
      var a = this.g;
      a =
        a == null || (_.xb && a != null && a instanceof Uint8Array)
          ? a
          : typeof a === 'string'
            ? xe(a)
            : null;
    ...
    var He,
      ...
      Ve = function (a) {
        for (var b = 0, c = a.g, d = c + 10, e = a.i; c < d; ) {
          var f = e[c++];
          b |= f;
          if ((f & 128) === 0) return (Ue(a, c), !!(b & 127));
        }
        throw Error('J');
      },
      We = function (a, b) {
      ...
      Me = function (a, b, c) {
        ...
        b &&
          ((b = ye(b)), (a.i = b.buffer), (a.l = b.za), (a.j = 0), (a.h = a.i.length), (a.g = a.j));
      };
    ...
    Ne.prototype.m = function () {
      ...
      if (_.sc) {
        var d = b,
          e;
        (e = Re) || (e = Re = new TextDecoder('utf-8', { fatal: !0 }));
        b = c + a;
        ...
        try {
          ...
          if (Qe === void 0) {
            ...
            try {
              (e.decode(new Uint8Array([97])), (Qe = !0));
            } catch (n) {
              Qe = !1;
            }
          }
            ...
            h < 128
              ...
              : h < 224
                ? c >= a
                  ? re()
                  : ((k = b[c++]),
                    h < 194 || (k & 192) !== 128 ? (c--, re()) : f.push(((h & 31) << 6) | (k & 63)))
                : h < 240
                  ? c >= a - 1
                    ? re()
                    : ((k = b[c++]),
                  ...
                  : h <= 244
                    ...
                    : re(),
            f.length >= 8192 && ((g = se(g, f)), (f.length = 0)));
        f = se(g, f);
      }
      return f;
    };
    ...
    _.af = function (a, b, c) {
      _.Ze(a, { timestamp: new Date().getTime(), type: 'error', errorType: b }, c);
    };
  } catch (e) {
    _._DumpException(e);
  }
  try {
    ...
    wf = function (a, b, c) {
      ...
      if (d & 256) {
        d = a[f - 1];
        for (var q in d)
          ((e = +q), Number.isNaN(e) || ((f = d[e]), f != null && (g = xf(c, e)) && g(b, f, e)));
      }
      if ((a = _.gb ? a[_.gb] : void 0))
        for (yf(b, b.g.end()), c = 0; c < a.length; c++) yf(b, a[c].h() || new Uint8Array(0));
    };
    xf = function (a, b) {
      var c = a[b];
      if (c) return c;
    ...
    Af = function (a, b) {
      for (var c, d, e = 1; e < arguments.length; e++) {
        ...
        for (var f = 0; f < zf.length; f++)
          ((c = zf[f]), Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]));
      }
    };
    _.Df = function (a, b) {
      a = new _.Ad(a);
    ...
    _.R = function (a, b, c) {
      if (c != null) {
        if (!Number.isFinite(c)) throw _.Va('enum');
        c |= 0;
      }
      return _.qd(a, b, c);
    };
    ...
    _.l = Uf.prototype;
    _.l.Xc = function (a, b) {
      b != null && (_.Sf(this.g, a * 8), this.g.g.push(b ? 1 : 0));
    };
    _.l.Yc = function (a, b) {
      b != null && ((b = parseInt(b, 10)), _.Sf(this.g, a * 8), _.Tf(this.g, b));
    };
    _.l.Rc = function (a, b) {
      if (b != null) {
        var c = !1;
    ...
    _.Bf = function (a) {
      var b = Wf(a);
      if (typeof b == 'undefined') throw Error('T');
      var c = new _.Gd(null);
      a = Vf(a);
    ...
    var gg = function (a, b) {
      ...
      eg;
    _.rc(gg, dg);
    for (var hg = [], ig = 0; ig < 63; ig++) hg[ig] = 0;
    ...
    var kg = function (a) {
      ...
      for (b = 16; b < 64; b++)
        ((d = c[b - 15] | 0),
          (e = c[b - 2] | 0),
          (c[b] =
            ((((c[b - 16] | 0) + (((d >>> 7) | (d << 25)) ^ ((d >>> 18) | (d << 14)) ^ (d >>> 3))) |
              0) +
              (((c[b - 7] | 0) +
      ...
      e = a.g[2] | 0;
      for (
        var f = a.g[3] | 0, g = a.g[4] | 0, h = a.g[5] | 0, k = a.g[6] | 0, m = a.g[7] | 0, n = 0;
        n < 64;
        n++
      ) {
        var q =
            ...
            0,
          r =
            (((m + (((g >>> 6) | (g << 26)) ^ ((g >>> 11) | (g << 21)) ^ ((g >>> 25) | (g << 7)))) |
              0) +
              ((((((g & h) ^ (~g & k)) + (eg[n] | 0)) | 0) + (c[n] | 0)) | 0)) |
            0;
        m = k;
        k = h;
        h = g;
    ...
    gg.prototype.update = function (a, b) {
      ...
      if (typeof a === 'string')
        for (; c < b; )
          ((this.i[d++] = a.charCodeAt(c++)), d == this.blockSize && (kg(this), (d = 0)));
      else if (Kf(a))
        for (; c < b; ) {
          var e = a[c++];
          if (!('number' == typeof e && 0 <= e && 255 >= e && e == (e | 0))) throw Error('Y');
          this.i[d++] = e;
          d == this.blockSize && (kg(this), (d = 0));
        }
      else throw Error('Z');
      this.h = d;
      this.j += b;
    ...
    _.l.clear = function () {
      for (var a = ng(this).keys, b = a.length - 1; b >= 0; b--) this.remove(a[b]);
    };
    ng = function (a) {
      a = (a.g.cookie || '').split(';');
    ...
    _.l.dispatchEvent = function (a) {
      ...
      a.i || ((g = a.h = c), (e = rg(g, d, !0, a) && e), a.i || (e = rg(g, d, !1, a) && e));
      if (b) for (f = 0; !a.i && f < b.length; f++) ((g = a.h = b[f]), (e = rg(g, d, !1, a) && e));
      return e;
    };
    _.l.fa = function () {
    ...
    _.l.Lc = function (a) {
      if (this.h) {
        ...
        for (d in b.g)
          if (!a || d == a) {
            for (var e = b.g[d], f = 0; f < e.length; f++) (++c, _.be(e[f]));
            delete b.g[d];
            b.h--;
          }
      }
    ...
    _.l.send = function (a, b, c, d) {
      if (this.G) throw Error('ba`' + this.Hb + '`' + a);
      b = b ? b.toUpperCase() : 'GET';
      this.Hb = a;
      this.Ab = !1;
      this.na = !0;
      this.G = new XMLHttpRequest();
      this.G.onreadystatechange = pg((0, _.Nf)(this.Jc, this));
      this.Xd &&
        'onprogress' in this.G &&
        ((this.G.onprogress = pg(
          (0, _.Nf)(function (g) {
            this.Ic(g, !0);
          }, this),
        )),
        this.G.upload && (this.G.upload.onprogress = pg((0, _.Nf)(this.Ic, this))));
      try {
        ((this.Eb = !0), this.G.open(b, String(a), !0), (this.Eb = !1));
      } catch (g) {
        xg(this);
        return;
      }
      ...
      'withCredentials' in this.G &&
        this.G.withCredentials !== this.Qb &&
        (this.G.withCredentials = this.Qb);
      ...
      try {
        (this.Da && (clearTimeout(this.Da), (this.Da = null)),
    ...
    sg.prototype.fa = function () {
      this.G &&
        (this.na && ((this.na = !1), (this.ya = !0), this.G.abort(), (this.ya = !1)), zg(this, !0));
      sg.ua.fa.call(this);
    };
    ...
    var Ag = function (a) {
      if (a.na && typeof _.ra != 'undefined')
        if (a.mb && Bg(a) == 4) setTimeout(a.Jc.bind(a), 0);
        else if ((a.dispatchEvent('readystatechange'), Bg(a) == 4)) {
          a.na = !1;
          try {
            var b = a.yc();
            a: switch (b) {
            ...
            d ? (a.dispatchEvent('complete'), a.dispatchEvent('success')) : yg(a);
          } finally {
            zg(a);
          }
        }
    ...
    sg.prototype.getResponseHeader = function (a) {
      if (this.G && Bg(this) == 4)
        return ((a = this.G.getResponseHeader(a)), a === null ? void 0 : a);
    };
    ...
    _.Fg = (function () {
      if (_.Rc) return Eg(/Firefox\/([0-9.]+)/);
      if (_.Hc || _.Ic || _.Gc) return _.Qc;
      if (_.Vc) {
        if (_.La() || _.Ma()) {
          var a = Eg(/CriOS\/([0-9.]+)/);
          if (a) return a;
      ...
      if (_.Wc && !_.La()) return Eg(/Version\/([0-9.]+)/);
      if (_.Sc || _.Tc) {
        if ((a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.ua()))) return a[1] + '.' + a[2];
      } else if (_.Uc) return (a = Eg(/Android\s+([0-9.]+)/)) ? a : Eg(/Version\/([0-9.]+)/);
      return '';
    })();
    _.Gg = window;
  } catch (e) {
  ...
  try {
    ...
    _.nl = function () {
      ...
      if (
        ...
        a = _.ua();
        var b = '';
        (_.Ja() ? _.wa.platform === 'Windows' : _.w('Windows'))
          ...
          : _.La()
            ...
            : _.Ma()
              ...
              : _.ua().toLowerCase().indexOf('kaios') != -1
    ...
    _.ml = function (a, b) {
      var c = 0;
      a = (0, _.vc)(String(a)).split('.');
      b = (0, _.vc)(String(b)).split('.');
    ...
    _.jl = function () {
      return _.va && _.wa
        ? _.wa.mobile
        : !_.kl() && (_.w('iPod') || _.w('iPhone') || _.w('Android') || _.w('IEMobile'));
    };
    _.kl = function () {
      return _.va && _.wa
        ? !_.wa.mobile && (_.w('iPad') || _.w('Android') || _.w('Silk'))
        : _.w('iPad') || (_.w('Android') && !_.w('Mobile')) || _.w('Silk');
    };
    var pl;
    pl = {};
    _.ql =
      ((pl.test_list = ['test_client_id']),
      (pl.cross_origin_iframe_rps =
  ...
  try {
    ...
    _.kj.prototype.L = function (a, b, c, d) {
      Array.isArray(b) || (b && (lj[0] = b.toString()), (b = lj));
    ...
    var mj = function (a, b, c, d, e, f) {
      if (Array.isArray(c)) for (var g = 0; g < c.length; g++) mj(a, b, c[g], d, e, f);
      else {
    ...
    _.kj.prototype.Ea = function (a, b, c, d, e) {
      if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.Ea(a, b[f], c, d, e);
      else
    ...
    _.oj.prototype.F = function () {
      if (this.i) {
        ...
        a > 0 && a < this.l * 0.8
          ? (this.g = this.j.setTimeout(this.B, this.l - a))
          : (this.g && (this.j.clearTimeout(this.g), (this.g = null)),
            this.dispatchEvent('tick'),
            this.i && (_.pj(this), this.start()));
      }
    };
  ...
  try {
                  ...
                  c
                    ? a.m && c.id === a.m
                      ? c.clientId !== a.s.client_id
                        ? _.N('Message ignored. Client id does not match.', 'OAUTH2_CLIENT')
                        : c.type !== 'authResult'
                          ? _.N('Message ignored. Invalid event type.', 'OAUTH2_CLIENT')
                          : ((a.m = void 0), a.i(c.authResult))
                      : _.N('Message ignored. Request id does not match.', 'OAUTH2_CLIENT')
                    : _.N('Message ignored. No params in message.', 'OAUTH2_CLIENT');
                }
              else _.N('Message ignored. No event data.', 'OAUTH2_CLIENT');
            } catch (d) {
    ...
    _.wj = function (a) {
      a.error_callback &&
        a.g &&
        !a.h &&
        (_.N('Starting popup timer.', 'OAUTH2_CLIENT'),
        (a.B = !1),
        (a.h = new _.oj(500)),
    ...
    _.tj.prototype.D = function () {
      ...
      !this.h ||
        ...
        (_.N('Popup window closed.', 'OAUTH2_CLIENT'),
  ...
  try {
    ...
    _.yj = function (a, b, c) {
      ...
      if (!c || c.closed || typeof c.closed === 'undefined')
        return (
          _.C('Failed to open popup window on url: ' + a + '. Maybe blocked by the browser?'),
          null
        );
      c.focus();
      return c;
  ...
  try {
            ...
            if (g) {
              ...
              switch (g) {
                ...
                case 'num':
                  e = Number(e);
                  isNaN(e)
                    ? _.C("Expected a number for '" + d + "'. Configuration ignored.")
                    : (c[f] = e);
                  break;
                case 'func':
                  typeof h[e] === 'function'
                    ? (c[f] = h[e])
                    : _.C("The value of '" + d + "' is not a function. Configuration ignored.");
                  break;
                case 'str':
                  c[f] = e;
                  break;
    ...
    Dp = !_.Hc && !_.Ha();
    _.Ep = function (a) {
      if (Dp && a.dataset) return a.dataset;
      var b = {};
      a = a.attributes;
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
  ...
  try {
        ...
        : _.Hp
          ...
          : Kp(a)
            ? ((Lp = a),
              Mp(),
              (a = _.Gp()),
              _.Fp(window.parent, { command: 'intermediate_iframe_ready', nonce: a }, '*'),
              (Jp = a),
              (Np = b),
              (Op = c))
            : _.C(
    ...
    Kp = function (a) {
      ...
      if (typeof a === 'string') return Qp(a);
      if (Array.isArray(a)) {
        for (var b = 0; b < a.length; b++) if (typeof a[b] !== 'string' || !Qp(a[b])) return !1;
        return !0;
      }
      return !1;
    };
    Qp = function (a) {
      try {
        ...
        if (!c.startsWith('*.'))
          return (_.C("Invalid origin pattern. Valid patterns should start with '*.'"), !1);
        a = c;
        b = 'Gb';
        if (Rp.Gb && Rp.hasOwnProperty(b)) var d = Rp.Gb;
        else {
          var e = new Rp();
          d = Rp.Gb = e;
        }
    ...
    Mp = function () {
      Tp ||
        (Tp = _.L(window, 'message', function (a) {
          a = a.g;
          if (a.data) {
            var b = a.data;
            b.sentinel === 'onetap_google' &&
              ...
              window.parent && window.parent === a.source
                ? Jp
                  ? b.nonce !== Jp
                    ? _.O('Message ignored due to invalid nonce.')
                    : (Up(a.origin)
                        ? ((_.Hp = a.origin), (_.Vp = b.parentMode || 'amp_client'), Np && Np())
                        : (_.O('Origin verification failed. Invalid origin - ' + a.origin + '.'),
                          Op && Op()),
                      (Op = Np = Jp = void 0),
                      Tp && (_.pe(Tp), (Tp = void 0)))
                  : _.O('Message ignored. Origin verifier is not ready, or already done.')
                : _.O('Message ignored due to invalid source.'));
          }
        }));
    };
    Up = function (a) {
      return typeof Lp === 'string'
        ? Wp(Lp, a)
        : Array.isArray(Lp)
          ? Lp.some(function (b) {
              return Wp(b, a);
    ...
    var cq = function (a, b, c) {
      a.g !== void 0 && c.push(b);
      for (var d in a.O) cq(a.O[d], b + d, c);
    };
    ...
    $p.prototype.remove = function (a) {
      ...
      for (delete b.g; c.length > 0; )
        if (((d = c.pop()), (b = d[0]), (d = d[1]), b.O[d].nb())) delete b.O[d];
        else break;
      return a;
    };
    ...
    _.E('google.accounts.id.intermediate.notifyParentDone', function () {
      _.Hp
        ? _.Ip({ command: 'intermediate_iframe_done' })
  ...
  try {
    var gq = function (a, b) {
        if (_.Fj(b)) ((a.href = _.Gj(b).toString()), (a.rel = 'stylesheet'));
        else {
          if (fq.indexOf('stylesheet') === -1) throw Error('Q`stylesheet');
          b = _.nc(b);
      ...
      hq = function () {
        var a = _.Gp().toString(),
          b = { Jb: 300, path: '/', Ob: !0 },
          c;
        if ((c = _.Ga())) c = _.ml(_.Fg, 80) >= 0;
        c && (b.Nb = 'none');
        c = _.Od(location.origin);
        c.h === 'http' && c.g === 'localhost' && ((b.Ob = void 0), (b.Nb = void 0));
      ...
      nq = function () {
        for (
          ...
          if (((b = b.value), b.getAttribute('name') === 'google-signin-client_id'))
      ...
      Cq = function (a, b) {
        Bq >= (b === void 0 ? 100 : b) ||
          ((b = new _.Ad(xq)),
          _.Dd(b, _.Bf({ client_id: yq, as: zq, event: a.toString() })),
          _.wg(
            b.toString(),
            void 0,
            'POST',
            void 0,
            void 0,
            xq !== 'https://accounts.google.com/gsi/log',
          ));
      },
      Gq = function (a) {
        var b = new (Function.prototype.bind.apply(
          Dq,
          [null, 'onetap', a, 'prompt'].concat(Eq(Fq.apply(1, arguments))),
        ))();
        Cq(b);
      },
      Hq = function () {
        var a = new (Function.prototype.bind.apply(
          Dq,
          [null, 'onetap', void 0, 'closed'].concat(Eq(Fq.apply(0, arguments))),
        ))();
        Cq(a);
      },
      Iq = function () {
        var a = new (Function.prototype.bind.apply(
          Dq,
          [null, 'id', void 0, 'init'].concat(Eq(Fq.apply(0, arguments))),
        ))();
        Cq(a);
      },
      Jq = function () {
        var a = new (Function.prototype.bind.apply(
          Dq,
          [null, 'onetap', void 0, 'policy'].concat(Eq(Fq.apply(0, arguments))),
        ))();
        Cq(a);
      },
      Kq = function (a) {
      ...
      Vq = function (a, b, c) {
        ...
        var f = _.L(document, 'securitypolicyviolation', function (g) {
          ...
          g.blockedURI &&
            ...
            ((g = document.location.ancestorOrigins ? document.location.ancestorOrigins.length : 0),
            Jq(
              'cspHeaderViolation',
              'topOrigin=' + (g > 0 ? document.location.ancestorOrigins[g - 1] : ''),
            ),
            _.pe(f));
        });
        b = new _.Ad(e);
        _.Dd(b, _.Bf({ client_id: a, as: c }));
      ...
      ar = function () {
        ...
        if (a) {
          ...
          a.auto_prompt &&
            ...
            _.og.get(a.skip_prompt_cookie) &&
            (a.auto_prompt = !1);
          delete a.skip_prompt_cookie;
          var c = {},
            d;
          for (d in b) b.hasOwnProperty(d) && Xq.indexOf(d.toLowerCase()) < 0 && (c[d] = b[d]);
          a.state && (c.state = a.state);
          if ((d = a.login_uri)) {
            b = _.Od(d);
            b.g ||
              (_.Bd(b, location.protocol),
            ...
            if (b.h !== 'https' && b.g !== 'localhost')
              throw (Iq('unsecuredLoginUri', d), new Yq('Unsecured login_uri provided.'));
            d = b.toString();
            a.login_uri = d;
            ...
            a.ux_mode === 'redirect' &&
              _.C('Missing required login_uri parameter for the redirect flow.');
          d = a.native_login_uri;
          delete a.native_login_uri;
          d && a.native_callback
            ? _.C('Cannot set both data-native_login_uri and data-native_callback.')
            : d &&
              (a.native_callback = $q(
                d,
                c,
      ...
      $q = function (a, b, c, d) {
        return function (e) {
          e && e.type === 'password'
            ? ((b[c] = e.id), (b[d] = e.password), _.Hf(a, b))
            : _.N('No password credential returned.');
        };
      },
      cr = function (a) {
        a = _.Ep(a);
      ...
      hr = function (a) {
        ...
        Mq(a.Id);
        fr(a);
        (_.U('enable_fedcm_button') || _.U('enable_fedcm_button_global_experiment')) &&
          tq(
            'fedcmButtonToken',
            'Ay4A+AH4Up5DVgU1SxjgSPmFoM8Q+Iuld2nz/Sez2Z15Nlho6Jz2FpQ8RtmxCQH+t+0aI1nKtVB0Z5jNMPEcGA4AAABweyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENtQnV0dG9uTW9kZSIsImV4cGlyeSI6MTczNjgxMjgwMCwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ==',
          );
        gr(a.I);
        return a;
      },
      ...
      kr = function (a, b, c) {
        ...
        } else _.O('Failed to render button because there is no parent or options set.');
      },
      mr = function () {
        var a = er.__G_ID_CLIENT__;
        a || (hr(), (a = er.__G_ID_CLIENT__));
        lr(a.v);
      },
      nr = function () {
        var a = a === void 0 ? document.readyState : a;
        for (var b = _.nf('g_id_signout'), c = 0; c < b.length; c++) _.L(b[c], 'click', mr);
        try {
          var d = ar();
          if (d) {
            var e = d.auto_prompt;
          ...
          for (var c = a.next(); !c.done; c = a.next()) {
            ...
            !d && d.indexOf(' ') >= 0
              ? (_.O(
                ...
                (c = null))
              : (c = d);
            if (c === null) return (_.O('Invalid scope found.'), null);
            c && b.push(c);
          }
        }
        return b;
      ...
      vr = { ve: 'signin', we: 'signup', ye: 'use' },
      wr = { me: 'card', le: 'bottom_sheet' },
      Yq = function () {
    ...
    var fq =
      ...
      Sq = function (a, b) {
        if ('textContent' in a) a.textContent = b;
          ...
          (_.Uj(a),
            a.appendChild(
              (a.nodeType == 9 ? a : a.ownerDocument || a.document).createTextNode(String(b)),
            ));
      },
      xr = _.Oe(_.Zf, _.cg),
      yr = ['debug', 'info', 'warn'],
    ...
    var Bq = Math.floor(Math.random() * 100),
      xq = 'https://accounts.google.com/gsi/log',
      yq,
      zq;
    var Lq = new Map();
    var Dr = function () {
      ...
      Er = function (a, b, c) {
        ...
        _.U('enable_fedcm_domain_hint') &&
          b.o.hosted_domain &&
          (d.domainHint = b.o.hosted_domain === '*' ? 'any' : b.o.hosted_domain);
        d = {
    ...
    var Kr = { left: 1, center: 2 },
      Lr = { rectangular: 1, square: 3, pill: 2, circle: 4 },
      Mr = { large: 1, medium: 2, small: 3 },
      Nr = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
      Or = { outline: 1, filled_blue: 2, filled_black: 3 },
      Pr = { standard: 1, icon: 2 },
      Qr = function (a, b, c) {
        this.u = a;
        this.h = c;
        this.g = !1;
        ...
        if (
          b &&
          (b.logo_alignment && _.R(a, 6, Kr[b.logo_alignment]),
          ...
          if (typeof b.width === 'number' && !isNaN(b.width)) _.mf(a, 4, Number(b.width));
    ...
    var as = { done: !0, value: void 0 };
    $r.prototype.Ia = function () {
      return this;
    };
    var es = function (a) {
        if (a instanceof bs || a instanceof cs || a instanceof ds) return a;
    ...
    var ns = function (a, b) {
      ...
      if (c) ps(a, c);
        ...
        if ((c = b.log_level !== void 0))
          ((c = b.log_level), (c = c === void 0 || (0, _.Na)(yr, c) >= 0));
        c && ps(a, b.log_level);
      }
      ...
      c = b.ui_mode;
      (c !== void 0 && Object.values(wr).includes(c)) ||
        ((c = a.u === document.body),
        (c =
          (_.jl() && !_.kl()) || ((c === void 0 || c) && vq() && window.innerWidth < 420)
            ? 'bottom_sheet'
            : 'card'));
      a.K = c;
      a.u =
      ...
      a.cb =
        b.enable_redirect_uri_validation === void 0 ? void 0 : !!b.enable_redirect_uri_validation;
      ...
      us = function (a) {
        setTimeout(function () {
          a.ma = _.L(document, 'click', function () {
            a.bb && rs(a, !1) && (ss(a, 'tap_outside'), ts(a));
          });
        });
      },
      ts = function (a) {
        a.ma && (_.pe(a.ma), (a.ma = void 0));
      },
      vs = function (a) {
        var b;
        (b = _.U('disable_fedcm')) ||
        ...
        _.U('enable_account_labels') &&
          tq(
            'accountLabelsToken',
            'A8Wqp9Xsd355jKrOU3SFVqNLi443LPonVpx8SpUUHoiNosN7c6tsbmtBe1piKMoMzkv6dQBydodR7MGG8Q/LFgMAAAB2eyJvcmlnaW4iOiJodHRwczovL2FjY291bnRzLmdvb2dsZS5jb206NDQzIiwiZmVhdHVyZSI6IkZlZENtQ29udGludWVPbkJ1bmRsZSIsImV4cGlyeSI6MTczNjg5OTE5OSwiaXNUaGlyZFBhcnR5Ijp0cnVlfQ==',
          );
        if (_.U('enable_fedcm_iframe_and_csp_detection')) return !0;
        b = document;
        if (
          (b.location.ancestorOrigins
            ? b.location.ancestorOrigins[b.location.ancestorOrigins.length - 1]
            : b.location.origin) === 'https://meet.google.com'
        )
          return !1;
        if (_.U('enable_fedcm_global_experiment'))
          return (_.A('In FedCM global experiment group'), !0);
        if (_.U('enable_fedcm_global_control')) return (_.A('In FedCM global control group'), !1);
        var c = a.o.client_id;
        b =
          (_.U('enable_fedcm_cross_origin_iframe') && !_.ql.cross_origin_iframe_rps.includes(c)) ||
          _.U('enable_forced_fedcm_cross_origin_iframe');
        if (
          (wq() && !a.s && !b) ||
          (a.s && a.o.auto_select && !(_.cf() >= 121)) ||
          (a.o.hosted_domain && !_.U('enable_fedcm_domain_hint') && !a.s)
        )
          return !1;
        (b = a.s === !1) &&
          _.O(
        ...
        c =
          (_.U('enable_fedcm_csp') && !_.ql.csp_rps.includes(c)) ||
          _.U('enable_forced_fedcm_cross_origin_iframe');
        a =
          (_.U('enable_manual_fedcm_launch') || c) &&
          (_.U('enable_fedcm_auto_reauthn') || !a.o.auto_select);
        return !b && (d || a);
      },
      ws = function (a) {
        return uq() && a.I.h && !_.U('enable_fedcm_button_global_control')
    ...
    os.prototype.sa = function (a, b, c) {
      if (b) {
        ...
        xs({ data: { announcement: _.sk({}) } });
        _.A('FedCM response :' + JSON.stringify(d));
        a === 'widget'
          ? (this.callback
              ? this.callback.call(this, d)
              : _.A('No callback found for FedCM widget flow'),
            ys(this, 'credential_returned'))
          : (c && c.state && (d.state = c.state),
            this.T === 'popup'
              ...
              : c && c.login_uri
                ? ((a = {}), c && c.state && (a.state = c.state), lq(c.login_uri, a, d.credential))
                : this.nc
                  ? this.nc.call(this, d)
    ...
    os.prototype.ga = function (a, b, c) {
      ...
      _.U('enable_fedcm_csp_compliance_detection') &&
        Vq(this.g.client_id ? this.g.client_id : '', this.B, this.m);
      window.location.href.startsWith('chrome-extension://')
        ? (_.O('Attempted to start sign in flow inside chrome extension.'),
          Gq(b, 'chromeExtension'))
        : (rs(this, !0) && ys(this, 'flow_restarted'),
          a &&
            !this.Wb &&
            (_.O(
          ...
          this.o.client_id
            ? _.U('unsupported_browser')
              ? (_.N('One Tap is not supported in this User Agent.'),
                this.i('browser_not_supported'),
                _.af(this, 'prompt_display_failed', {
                  cause: 'Unsupported user agent for one tap.',
                }))
              : Yr(this.v)
                ? (_.N('User has closed One Tap before. Still in the cool down period.'),
                  this.i('suppressed_by_user'),
                  _.af(this, 'prompt_display_failed', {
                    cause: 'Prompt disabled by the user.',
                  }),
                  Gq(b, 'cooldown', (Wr(this.v).prompt_suppress_level || 0).toString()))
                : vs(this)
                  ? ((this.H = !0),
                    Ir(this.I, {
                      rc: this.eb,
                  ...
                  : zs(this, function (e) {
                      e && _.Yi(_.F(e, 3))
                        ...
                        : e && _.rd(e, _.M, 2)
                          ...
                          : e && !_.Yi(_.F(e, 3)) && _.nl() && d.Xb
                            ? ((d.o.is_itp = !0), As(d), Bs(d), Cs(d, !0), us(d), delete d.o.is_itp)
                            : e && !_.Yi(_.F(e, 3))
                              ? (_.A('No sessions found in the browser.'),
    ...
    var jr = function (a, b, c, d) {
          ...
          d
            ? d.wa
              ...
              : ((b = {}),
                ...
                Gs(a, b),
                d.hc && d.hc(Object.assign({}, d.data)))
            : _.C('A button entry was not found for the given id.');
        }
      },
      Gs = function (a, b) {
        rs(a, !0) && (ys(a, 'flow_restarted'), Hq('buttonFlowStarted'));
        ...
        ws(a)
          ? ((a.H = !0),
            Jr(a.I, {
              ...
              Cb: { state: b.state, login_uri: a.o.login_uri },
            }))
          : a.T === 'redirect'
            ? Hs(a)
            : Is(a);
      ...
      Hs = function (a) {
        a.o.login_uri ||
          (a.o.login_uri = location.protocol + '//' + location.host + location.pathname);
        a.o.g_csrf_token = hq();
        ...
        } else _.kf(top.location, _.lc(_.Df(a.mc, a.o)));
      },
      Is = function (a) {
        a.l = _.Gp();
        ...
        if (_.U('enable_gis_oauth_button_flow_popup')) {
          ...
          try {
            ...
            (_.O('validateTransformLayerPayload failed'), (m = !1));
          }
          m ||
            Cq(
              new Dq(
                ...
                'origin=' + a.o.origin,
                'clientId=' + a.o.client_id,
                'gisParams=' + b.gis_params,
              ),
            );
          if (_.yj(_.Df(a.Ha, b), ms, _.xj())) return;
          Cq(new Dq('button', 'popup', 'clicked', 'oauthPopupNotOpened'));
        }
        _.yj(_.Df(a.mc, a.o), ms, _.xj()) ||
          Cq(new Dq('button', 'popup', 'clicked', 'popupNotOpened'));
      },
      rs = function (a, b) {
        if (a.H)
          return (
              ...
              ? ((b = b.g),
                ...
                b.h
                  ? (b.h.abort(),
                    ...
                    (b.h = void 0),
                    (b = !0))
                  : (_.A('No FedCM flow to abort. callId ' + b.g), (b = !1)))
              : (_.A('No FedCM flow to abort.'), (b = !1)),
            b ? (ts(a), !0) : !1
          );
        if (Uq(a.u)) var c = !a.J;
        else
        ...
        if (c) return !1;
        if (!b && a.F)
          return (_.N('Cancel prompt request ignored. The prompt is in a protected state.'), !1);
        Uq(a.u)
          ? ((b = a.J) && b.parentElement
            ...
            (b = !b))
          : (b = !Nq(a.u));
        if (b) return (_.N('Failed to remove prompt iframe.'), !1);
        sr(a);
        a.F = !0;
        a.J = void 0;
        ts(a);
    ...
    var Cs = function (a, b, c) {
      ...
      zs = function (a, b) {
        ...
        iq(c, function (d) {
          d && d !== 'null'
            ? ((d = Ar(JSON.stringify(_.Zi(d)))), b(d))
            : (_.C('Check credential status returns invalid response.'),
              a.i('unknown_reason'),
                        ...
                        case 'resize':
                          ...
                          if (f) {
                            ...
                            if (g && g.Wa && Qq(h) && Qq(k)) {
                              ...
                              m
                                ? _.O('Unable to resize iframe. Invalid dimensions.')
                                : _.O(
          ...
          case 'response':
            ...
            if (d) {
              ...
              f.prompt_suppress_level &&
                Cq(new Dq('onetap', void 0, 'resetCooldown', f.prompt_suppress_level.toString()));
              f.prompt_suppress_level = 0;
              Xr(e, f);
              e.Ka();
              this.callback &&
                (this.callback.call(this, c), _.A('Response received: ' + JSON.stringify(c)));
              c = this.o.client_id;
              e = nq();
              if (c && e) {
                f = oq(c);
            ...
            b &&
              (d
                ? ys(this, 'credential_returned')
                : (ss(this, 'issuing_failed'), Hq('issuingFailed')),
              sr(this));
            xs(a);
            break;
          case 'activity':
            ...
            if ((b = a.data.command))
              switch (b) {
                case 'close':
                  a.data.suppress &&
                    ...
                    (b.disable_auto_prompt =
                      new Date().getTime() + Tr[b.prompt_suppress_level] * 1e3),
                    Cq(
                      new Dq('onetap', void 0, 'startCooldown', b.prompt_suppress_level.toString()),
                    ),
                    Xr(a, b));
                  rs(this, !0) && (ss(this, 'user_cancel'), sr(this));
                  break;
                case 'resize':
                  a = a.data.height;
                  if (Qq(a)) {
                ...
                case 'cancel_auto_select':
                  (lr(this.v), Js(this, 'auto_select_canceled'));
              }
        }
    };
    var xs = function (a) {
    ...
    os.prototype.revoke = function (a, b) {
      var c = { successful: !1 },
        d = this.o.client_id;
      d
        ? _.U('enable_fedcm_revocation_client') && 'IdentityCredential' in window && _.cf() >= 123
    ...
    var dr = function (a) {
      ...
      if (this.h && this.h)
        if (typeof this.h === 'string') {
          if (!mq(this.h)) throw Error('Ja');
        } else if (Array.isArray(this.h))
          for (a = 0; a < this.h.length; a++)
            if (typeof this.h[a] !== 'string' || !mq(this.h[a])) throw Error('Ka');
    };
    _.D(dr, os);
      ...
      this.Y && this.h
        ? (_.A('Verifying parent origin.'),
          _.Pp(this.h, function () {
            _.Hp
              ? _.Ip({ command: 'set_ui_mode', mode: d.K })
    ...
    dr.prototype.Ga = function (a) {
      ...
      if (this.Y && a.data && a.data.type)
        switch (a.data.type) {
          case 'response':
            a.data.response && a.data.response.credential && ((this.pc = !0), _.Xp(0));
            break;
          case 'command':
            switch (a.data.command) {
              case 'close':
                this.pc ? _.Xp(0) : this.gb ? (_.Xp(0), this.gb()) : _.Yp();
                break;
              case 'resize':
                a = a.data.height;
    ...
    _.E('google.accounts.id.setLogLevel', function (a) {
      ...
      b || (hr(), (b = er.__G_ID_CLIENT__));
      a = a ? a.toLowerCase() : void 0;
      a === void 0 || (0, _.Na)(yr, a) >= 0
        ? ps(b, a, !0)
        : (_.C(
    ...
    Ms.prototype.requestCode = function () {
      var a = this.s;
      this.T === 'redirect'
        ? (_.N('Starting redirect flow.', 'CODE_CLIENT'),
          _.jj(window.location, _.lc(qq(this.j, this.l, a))))
        : (_.N('Starting popup flow.', 'CODE_CLIENT'),
          _.uj(this),
          _.vj(this, a),
          (this.g = _.yj(qq(this.j, this.l, a), Ls, _.xj())),
          !this.g && this.error_callback
            ? this.error_callback(new _.rj('Failed to open popup window', 'popup_failed_to_open'))
            : _.wj(this));
    };
    ...
    Ps.prototype.i = function (a) {
      ...
      if (a.access_token)
        if (Os.gapi && Os.gapi.client && Os.gapi.client.setToken)
          try {
            ...
            (_.C('Set token failed. Exception encountered.', 'TOKEN_CLIENT'), console.Bb(b));
          }
        else
          _.N(
      ...
      else _.O('Set token failed. No access token in response.', 'TOKEN_CLIENT');
      this.callback && this.callback.call(this, a);
    };
    Ps.prototype.requestAccessToken = function (a) {
      ...
      a.enable_granular_consent =
        a.enable_granular_consent === void 0 ? a.enable_serial_consent : a.enable_granular_consent;
      b = _.sj(this.j, {
        client_id: b.client_id,
        ...
        include_granted_scopes:
          a.include_granted_scopes === void 0 ? b.include_granted_scopes : a.include_granted_scopes,
        enable_granular_consent:
