...
(function (_) {
  ...
  try {
    ...
    */
    ...
    sd = function (a, b, c, d) {
      ...
      var f;
      if (d != null && d.pb === mb)
        return (b = _.Hb(d)), b !== d && _.Jb(a, e, c, b), b.A;
      if (Array.isArray(d)) {
        var g = (0, _.db)(d);
        g & 2
          ? (f = _.vb(_.Gb(d, g, !1), b, !0))
          : g & 64
            ? (f = d)
            : (f = _.vb(f, b, !0));
    ...
    _.Td = function (a, b, c) {
      a.remove(b);
      c.length > 0 &&
        ((a.i = null), a.g.set(Rd(a, b), _.Pa(c)), (a.h += c.length));
    };
    ...
    _.pe = function (a) {
      ...
      he--;
      (c = _.le(b))
        ? (_.ee(c, a), c.h == 0 && ((c.src = null), (b[fe] = null)))
        : _.be(a);
      return !0;
    };
    ne = function (a) {
  ...
  try {
    ...
    ye = function (a) {
      ...
      if (a.constructor === _.yb)
        return { buffer: a.h() || new Uint8Array(0), za: !0 };
  ...
  try {
    ...
    wf = function (a, b, c) {
      ...
      if (d & 256) {
        ...
        for (var q in d)
          (e = +q),
            Number.isNaN(e) ||
              ((f = d[e]), f != null && (g = xf(c, e)) && g(b, f, e));
      }
      if ((a = _.gb ? a[_.gb] : void 0))
        for (yf(b, b.g.end()), c = 0; c < a.length; c++)
    ...
    _.l.Yc = function (a, b) {
      b != null &&
        ((b = parseInt(b, 10)), _.Sf(this.g, a * 8), _.Tf(this.g, b));
    };
    _.l.Rc = function (a, b) {
      if (b != null) {
        var c = !1;
    ...
    Yf = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.oc(d) ? !!d.capture : !!d),
          ...
          _.Zd(a)
            ? a.Ea(b, c, d, e)
            : a && (a = _.le(a)) && (b = a.Ua(b, c, d, e)) && _.pe(b);
    };
    _.Zf = function (a) {
      this.A = _.y(a);
    };
    ...
    var gg = function (a, b) {
        ...
        eg === void 0 &&
          (_.v.Int32Array ? (eg = new Int32Array(fg)) : (eg = fg));
        this.reset();
      },
      eg;
    _.rc(gg, dg);
    ...
    gg.prototype.digest = function () {
      var a = [],
        b = this.j * 8;
      this.h < 56
        ? this.update(jg, 56 - this.h)
        : this.update(jg, this.blockSize - (this.h - 56));
    ...
    _.l.send = function (a, b, c, d) {
      ...
      this.Xd &&
        ...
        this.G.upload &&
          (this.G.upload.onprogress = pg((0, _.Nf)(this.Ic, this))));
      try {
    ...
    var xg = function (a) {
      ...
      yg = function (a) {
        a.Ab ||
          ((a.Ab = !0), a.dispatchEvent("complete"), a.dispatchEvent("error"));
      };
    ...
    sg.prototype.fa = function () {
      this.G &&
        (this.na &&
          ((this.na = !1), (this.ya = !0), this.G.abort(), (this.ya = !1)),
        zg(this, !0));
      sg.ua.fa.call(this);
    };
  ...
  try {
    ...
    _.ll = function () {
      return ![_.Ga() && !_.jl() && !_.kl(), _.Ga() && _.hl(), _.Da()].some(
        function (a) {
          return a;
        },
      );
  ...
  try {
    ...
    var mj = function (a, b, c, d, e, f) {
      if (Array.isArray(c))
        for (var g = 0; g < c.length; g++) mj(a, b, c[g], d, e, f);
      else {
    ...
    _.oj.prototype.start = function () {
      this.i = !0;
      this.g ||
        ((this.g = this.j.setTimeout(this.B, this.l)), (this.D = Date.now()));
    };
    _.pj = function (a) {
      a.i = !1;
  ...
  try {
    ...
    _.tj.prototype.D = function () {
      ...
      !this.h ||
        ...
        this.error_callback &&
          this.error_callback(new _.rj("Popup window closed", "popup_closed")),
        _.pj(this.h),
  ...
  try {
    ...
    Kp = function (a) {
      ...
      if (Array.isArray(a)) {
        for (var b = 0; b < a.length; b++)
          if (typeof a[b] !== "string" || !Qp(a[b])) return !1;
        return !0;
      }
      return !1;
    };
  ...
  try {
    var gq = function (a, b) {
      ...
      Zq = function (a, b) {
        return function (c) {
          c && c.credential
            ? lq(a, b, c.credential)
            : _.N("No credential found in the response.");
        };
      },
      $q = function (a, b, c, d) {
        return function (e) {
      ...
      kr = function (a, b, c) {
        if (a && b) {
          ...
          d
            ? jr(d, a, b, c)
            : _.O("Failed to render button before calling initialize().");
        } else
          _.O(
    ...
    var Dr = function () {
      ...
      Er = function (a, b, c) {
        ...
        _.U("enable_fedcm_domain_hint") &&
          b.o.hosted_domain &&
          (d.domainHint =
            b.o.hosted_domain === "*" ? "any" : b.o.hosted_domain);
        d = {
      ...
      c
        ? (_.A("Processing FedCM response. callId " + this.g),
          c.login
            ...
            : a.sa(b, c, a.Cb))
        : (_.A("FedCM credential is null. callId " + this.g),
          a.Aa(b, Error("Ga")));
    };
    var Gr = function () {
        this.h = !1;
    ...
    var ns = function (a, b) {
      ...
      c.ui_mode = a.K;
      b.context !== void 0 &&
        Object.values(vr).includes(b.context) &&
        (c.context = b.context);
    ...
    var fr = function (a) {
      ...
      vs = function (a) {
        ...
        if (_.U("enable_fedcm_global_control"))
          return _.A("In FedCM global control group"), !1;
        var c = a.o.client_id;
        b =
          (_.U("enable_fedcm_cross_origin_iframe") &&
            !_.ql.cross_origin_iframe_rps.includes(c)) ||
              ...
              : Yr(this.v)
                ? (_.N(
                  ...
                  Gq(
                    b,
                    "cooldown",
                    (Wr(this.v).prompt_suppress_level || 0).toString(),
                  ))
                : vs(this)
                  ? ((this.H = !0),
                    Ir(this.I, {
                      ...
                      Aa: function (e, f) {
                        if (_.U("enable_fedcm_csp_and_iframe_logs")) {
                          ...
                          g =
                            g > 0
                              ? document.location.ancestorOrigins[g - 1]
                              : "";
                          var h = [
                          ...
                          : e && !_.Yi(_.F(e, 3)) && _.nl() && d.Xb
                            ...
                            : e && !_.Yi(_.F(e, 3))
                              ? (_.A("No sessions found in the browser."),
                                ...
                                _.af(d, "prompt_display_failed", {
                                  cause:
                                    "No signed in Google accounts available.",
                                }))
                              : (_.A(
      ...
      Es = function (a, b) {
        ...
        if (b) {
          ...
          d
            ? d.wa
              ? (d.wa(d.data),
                _.A("Custom handler called for button: " + b + "."))
              : ((b = {}),
                d.data &&
    ...
    var Bs = function (a) {
      ...
      qs = function (a, b) {
        if (b.origin === a.B && b.data && b.data.type === "readyForConnect")
          if (
            (_.A("Setup message received: " + JSON.stringify(b.data)), b.source)
          ) {
    ...
    os.prototype.Ga = function (a) {
      if (a.data && a.data.type)
        switch (
          (_.A("Message received: " + JSON.stringify(a.data)), a.data.type)
        ) {
          case "response":
            var b = rs(this, !0),
              c = a.data.response,
      ...
      this.T === "redirect"
        ...
        : (_.N("Starting popup flow.", "CODE_CLIENT"),
          ...
          !this.g && this.error_callback
            ? this.error_callback(
                new _.rj("Failed to open popup window", "popup_failed_to_open"),
              )
            : _.wj(this));
    };
